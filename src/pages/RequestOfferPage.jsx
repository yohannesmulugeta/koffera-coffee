        ...
        <div className="container offer-layout">
          ...
          <form className="form-card" onSubmit={handleSubmit} noValidate={false}>
            ...
            <div className="form-grid">
              ...
              <label>Buyer type<select name="buyerType" required defaultValue=""><option value="" disabled>Select buyer type</option><option>Specialty roaster</option><option>Importer / distributor</option><option>Private-label brand</option><option>Café / hospitality</option><option>Retail coffee company</option><option>Other</option></select></label>
              <label>Expected purchase date<input name="purchaseDate" type="month" /></label>
              <label>Preferred origin<select name="origin" defaultValue=""><option value="">Any available origin</option>{origins.map((origin) => <option key={origin.slug}>{origin.name}</option>)}</select></label>
              <label>Processing method<select name="process" defaultValue=""><option value="">Any process</option><option>Washed</option><option>Natural</option><option>Open to recommendation</option></select></label>
              ...
              <label>Sample required<select name="sample" defaultValue="Yes"><option>Yes</option><option>No</option><option>Not sure</option></select></label>
